          ...
          <el-table
            ...
            <el-table-column
              ...
              <template slot-scope="scope">
                <el-button @click="showEditEmpView(scope.row)" style="padding: 3px 4px 3px 4px;margin: 2px;;width:80px"
                           size="small">编辑
                </el-button>
                <el-button type="danger" style="padding: 3px 4px 3px 4px;margin: 2px;width:80px" size="small"
